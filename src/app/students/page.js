...
export default function Students() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, formikHelpers) => {
      ...
      const student_history_data = await fetchStudentHistory(
      ...
      console.log(student_history_data);
              ...
              <>
                ...
                <div className="flex flex-col lg:flex-row lg:space-x-2 lg:items-center">
                  ...
                  <Button
                    variant="outline"
                    className={
                      "flex space-x-1 items-center justify-center dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit dark:border dark:border-gray-700 lg:dark:bg-zinc-800/30"
                    }
                    type="submit"
                ...
                {formik.values.admission_number.length > 0 && (
                  <div className="text-gray-500 text-xs hidden">
                    Press{" "}
                ...
                <div className="flex space-x-10 mt-10">
                  <a
                    ...
                    target="_blank"
                    className={
                      "text-[#039be5] underline flex gap-1 items-center"
                    }
                  >
                    {"View Summary"}
